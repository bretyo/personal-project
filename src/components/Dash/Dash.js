    ...
    return(
        <animated.div style={loadDash} className='header-padded dashboard'>
            <section className='dash-desc'>
                ...
                <p>BretBox is a hub for games (inspired by JackBox) you can play with your friends/family!</p>
            ...
            <section className='dash-newgame'>
                <p>(Note: Starting a game is best done on a laptop or device with a standard 13 inch size screen or larger. Join the game from a device of your choice!)</p>
